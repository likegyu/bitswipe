...
export const Footer = () => {
    return (
        <footer className="w-full py-4 px-4 text-center text-[11px] sm:text-xs text-gray-400 flex flex-col gap-3">
            ...
            <div>
                <p className="text-[10px] sm:text-[10px] text-gray-500">© 2025 Bitswipe. This is a simulation game.</p>
                <p className="text-[10px] sm:text-[10px] text-gray-500">
