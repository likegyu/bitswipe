        ...
        <div className="w-full py-16 px-2 md:px-4 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 word-break-keep-all">
            ...
            <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-3xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700">
                ...
                <div className="p-2 sm:p-8 md:p-12 lg:p-16">
                    ...
                    <Section>
                        <SectionHeader
                            title={t('FuturesSection.title')}
                            description={t('FuturesSection.p1')}
                        />
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            <Card className="flex flex-col items-center text-center p-8">
                                <div className="w-16 h-16 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mb-4 text-yellow-600 dark:text-yellow-400">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                                    {t('FuturesSection.card1_title')}
                                </h3>
                                <p className="text-gray-600 dark:text-gray-400">
                                    {t('FuturesSection.card1_text')}
                                </p>
                            </Card>
                            <Card className="flex flex-col items-center text-center p-8">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                                    {t('FuturesSection.card2_title')}
                                </h3>
                                <p className="text-gray-600 dark:text-gray-400">
                                    {t('FuturesSection.card2_text')}
                                </p>
                            </Card>
                        </div>
                        <div className="text-center">
                            <Link
                                href="/futures"
                                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-yellow-500 rounded-xl hover:bg-yellow-400 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                            >
                                {t('FuturesSection.cta_button')}
                                <ChevronRight className="w-5 h-5 ml-2" />
                            </Link>
                        </div>
                    </Section>
