            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl p-6 z-[70] max-w-md mx-auto shadow-2xl"
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center mb-2">
                                    <label className="font-bold text-gray-700">Leverage</label>
                                    <span className="text-primary font-bold">{settings.leverage}x</span>
                                </div>
                            ...
                            <button
                                onClick={handleReset}
                                className="cursor-pointer w-full py-4 mt-4 bg-red-50 text-error font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-red-100 transition-colors"
                            >
                                <RefreshCw size={20} />
                                Reset Game
                            </button>
