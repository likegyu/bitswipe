                                ...
                                <>
                                    ...
                                    >
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                            <span className="text-error font-bold text-2xl sm:text-4xl -rotate-12">SHORT</span>
                                        </div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                            <span className="text-success font-bold text-2xl sm:text-4xl rotate-12">LONG</span>
                                        </div>
                                    </div>
                                </>
                            )}
