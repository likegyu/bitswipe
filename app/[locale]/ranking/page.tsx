        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20">
            <div className="max-w-2xl mx-auto p-4">
                ...
                {loading ? (
                    ...
                    <div className="text-center text-gray-500 py-20 bg-white dark:bg-gray-900 rounded-3xl shadow-sm">
                        {t('no_rankings')}
                    </div>
                ) : (
                    <div className="space-y-3">
                        {rankings.map((ranking, index) => (
                            <motion.div
                                ...
                                className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-100 dark:border-gray-800"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-gray-400 font-medium">
                                            {t('win_label')} {Math.round(ranking.investment_style.winRate ?? ranking.investment_style.win_rate ?? 0)}%
                                        </div>
                                    </div>
                                            ...
                                            <div className="p-4">
                                                ...
                                                {ranking.investment_style.history && (
                                                    <button
                                                        ...
                                                        className="w-full py-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-bold rounded-xl transition-colors shadow-sm border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-2 text-sm"
                                                    >
                                                        <Activity size={16} />
                                                        {t('view_analysis')}
                                                    </button>
